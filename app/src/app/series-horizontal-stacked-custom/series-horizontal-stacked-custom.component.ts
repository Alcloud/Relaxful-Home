...
@Component({
    ...
    selector: 'ngx-charts-bar-horizontal-stacked-custom',
    template: `
      <ngx-charts-chart
        [view]="[width, height]"
        [showLegend]="legend"
        ...
        <svg:g [attr.transform]="transform" class="bar-chart chart">
          ...
          <svg:g
            *ngFor="let group of results; let index = index; trackBy:trackBy"
            ...
            <svg:g ngx-charts-series-horizontal-custom
              type="stacked"
              [xScale]="xScale"
              [yScale]="yScale"
              [colors]="colors"
    ...
    styleUrls: ['./my-base-chart.component.css'],
...
export class MyBarHorizontalStackedComponent extends BaseChartComponent {
