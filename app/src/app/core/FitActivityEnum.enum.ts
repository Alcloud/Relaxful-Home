// exported from https://developers.google.com/fit/rest/v1/reference/activity-types
export enum FitActivityType {
    ...
    SLEDDING = 71,
    SLEEPING = 72,
    LIGHT_SLEEP = 109, // relevant sleep type
    DEEP_SLEEP = 110, // relevant sleep type
    REM_SLEEP = 111, // relevant sleep type
    AWAKE_DURING_SLEEP_CYCLE = 112, // relevant sleep type
    SNOWBOARDING = 73,
    SNOWMOBILE = 74,
    SNOWSHOEING = 75,
    SOFTBALL = 120,
    SQUASH = 76,
    STAIR_CLIMBING = 77,
    STAIR_CLIMBING_MACHINE78,
    STAND_UP_PADDLEBOARDING79,
    STILL_NOT_MOVING = 3,
    ...
    TABLE_TENNIS_PING_PONG85,
    TEAM_SPORTS = 86,
    TENNIS = 87,
    TILTING_SUDDEN_DEVICE_GRAVITY_CHANGE = 5,
    TREADMILL_WALKING_OR_RUNNING88,
